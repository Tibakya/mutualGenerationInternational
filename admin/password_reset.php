    ...
    <div class="card-body login-card-body">
      ...
      <form method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" name="ad_pass" class="form-control" placeholder="New User Name">
        ...
        <div class="input-group mb-3">
          <input type="password" name="ad_pass" class="form-control" placeholder="Old Password">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="row">
          ...
          <div class="col-">
          <button class="btn btn-danger mr-lg-5 "><a href="index.php" >Cancel</a></button>
