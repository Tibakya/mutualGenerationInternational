...
// Check user role; redirect if the user is not an editor
if (isset($_SESSION['role']) && $_SESSION['role'] !== 'editor') {
    header('Location: unauthorized_access.php'); // Redirect to unauthorized access page
    exit();
}
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <?php include "sidebar_editor.php"; ?>
